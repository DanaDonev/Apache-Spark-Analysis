...
WHERE publication_year >= 2000
  AND institution_name IN ('University of Primorska', 'University of Ljubljana', 'University of Maribor', 'Jožef Stefan Institute', 'Jožef Stefan International Postgraduate School')
